# DeFi Lending Platform with Flash Loans

A complete decentralized lending platform built with Solidity smart contracts and React, featuring collateralized borrowing, interest-bearing deposits, flash loans, and on-chain reputation tracking.

## Features

- **Lending**: Deposit ERC-20 tokens to earn interest
- **Borrowing**: Borrow against collateral with 75% LTV ratio
...
- **MetaMask Integration**: Sign transactions directly from your wallet
